...
* **Interpolação Linear:** Aqui a matemática fica mais elegante. O computador calcula uma média ponderada entre dois pontos reais para criar o ponto falso no meio, usando a equação.
